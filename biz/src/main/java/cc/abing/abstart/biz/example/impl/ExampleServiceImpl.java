...
public class ExampleServiceImpl implements ExampleService {
    ...
    @Override
    public List<ExampleDO> listExampleDO(Long id, Date startCreateTime, Date endCreateTime, Integer pageIndex, Integer pageSize) {
    ...
    @Override
    public Page<ExampleDO> pageExampleDO(Long id, Date startCreateTime, Date endCreateTime, Integer pageIndex, Integer pageSize) {
    ...
    public Page<ExampleDO> pageExampleDO(ExampleRequest request) {
        return exampleMapper.selectPage(PageDTO.<ExampleDO>of(request.getPageIndex(), request.getPageSize()), Wrappers.<ExampleDO>lambdaQuery()
                .eq(request.getId() != null, ExampleDO::getId, request.getId())
                .ge(request.getStartCreateTime() != null, ExampleDO::getCreateTime, request.getStartCreateTime())
    ...
    public Integer modifyExampleDO(ExampleRequest request) {
        ExampleDO exampleDO = ExampleConverter.M.convert(request);
        return exampleMapper.update(exampleDO,Wrappers.<ExampleDO>lambdaUpdate().eq(ExampleDO::getId,exampleDO.getId()));
    }
